...
export default function Controls() {
    ...
    useEffect(() => {
        const timeoutId = setTimeout(() => {
            if (isRotate) {
                const newUrl = "https://avrora-poltava.netlify.app/";
                window.location.href = newUrl;
            }
        }, 60000);

        return () => {
            // Відміна події при відміні компонента чи зміні isRotate
    ...
    useFrame(() => {
        ...
        setIsRotate(timeSinceInteraction > 5000 && !panorama.isPanoramaIFrame ? true : false);
    });
